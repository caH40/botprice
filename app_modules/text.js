...
const selectorBikeDisCountry = 'body > div:nth-child(4) > div > header > div.top-bar > div > nav > div.navigation--entry.entry--service.has--drop-down.delivery.js--is--dropdown-active > ul > li.service--entry.flag-icon-ru.entry136.service--link';
